...
public class TC008_ReOrder_Product extends BaseClass {
	String expectedProdcutName = "LG LCD";
	int updateQty = 2;
	String ShipCost;
	double subTotalPriceAfterUpdate;
	...
	public void reOrder() throws InterruptedException
	{
		...
		List<WebElement> rows = driver.findElements(By.xpath("//table[@id='shopping-cart-table']//tr"));
		for(int i =1; i<rows.size()-1;i++)
		{
			String actualProductName = driver.findElement(By.xpath("//table[@id='shopping-cart-table']//tr["+i+"]//td[2]")).getText();
			if(actualProductName.contains(expectedProdcutName))
			{
				String productPrice = driver.findElement(By.xpath("//table[@id='shopping-cart-table']//tr["+i+"]//td[3]")).getText();
				double productPrize = Double.parseDouble(productPrice.replace("$", ""));
				
				String subTotalPrice = driver.findElement(By.xpath("//table[@id='shopping-cart-table']//tr["+i+"]//td[5]")).getText();
				double subTotalPriceBeforeUpdate = Double.parseDouble(subTotalPrice.replaceAll("[$,]", ""));
				
				driver.findElement(By.xpath("//table[@id='shopping-cart-table']//tr["+i+"]//td[4]/input[@title='Qty']")).clear();
				driver.findElement(By.xpath("//table[@id='shopping-cart-table']//tr["+i+"]//td[4]/input[@title='Qty']")).sendKeys(String.valueOf(updateQty));
				driver.findElement(By.xpath("//table[@id='shopping-cart-table']//tr["+i+"]//td[4]/button[@title='Update']")).click();
				
				String updatedsubTotalPrize = driver.findElement(By.xpath("//table[@id='shopping-cart-table']//tr["+i+"]//td[5]")).getText();
				double subTotalPriceAfterUpdate = Double.parseDouble(updatedsubTotalPrize.replaceAll("[$,]", ""));
								
				if(subTotalPriceAfterUpdate==(productPrize*updateQty)) {
	...
	public void proceedToCheckOut()
	{
		...
		double lblGrandTotal = Double.parseDouble(ShipCost) + subTotalPriceAfterUpdate;
